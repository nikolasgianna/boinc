...
struct JOB_DESC {
    ...
    JOB_DESC() {
        ...
        wu.rsc_fpops_bound =  DEFAULT_FPOPS_BOUND;//86400e9;
        wu.rsc_memory_bound =  DEFAULT_MEMORY_BOUND;//5e8;
        wu.rsc_disk_bound =  DEFAULT_DISK_BOUND;//1e9;
        wu.rsc_bandwidth_bound = 0.0;
        wu.delay_bound = DEFAULT_DELAY_BOUND;//7*86400;
